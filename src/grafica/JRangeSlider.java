...
/**
 * UI delegate for the JRangeSlider component.  JRangeSliderUI paints two thumbs,
 * one for the lower value and one for the upper value.
 */
class JRangeSliderUI extends BasicSliderUI {
    ...
    /**
     * Constructs a JRangeSliderUI for the specified slider component.
     * @param b JRangeSlider
     */
    public JRangeSliderUI(JRangeSlider b) {
        super(b);
    }
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(this.lowerColor);
        g2d.fill(thumbShape);

        g2d.setColor(this.lowerBorderColor);
        g2d.draw(thumbShape);
    ...
    private void paintUpperThumb(Graphics g) {
        ...
        g2d.setColor(this.upperColor);
        g2d.fill(thumbShape);

        g2d.setColor(this.upperBorderColor);
        g2d.draw(thumbShape);
...
/**
 * Classe per la gestione del range selezionato da un JRangeSlider.
 * 
